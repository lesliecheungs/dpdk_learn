...
static void ng_init_port(struct rte_mempool *mbuf_pool)
{
    ...
    if(rte_eth_tx_queue_setup(gDpdkPortId, 0, 128, rte_eth_dev_socket_id(gDpdkPortId), NULL, mbuf_pool) < 0)
    {
...
static void create_eth_ip_udp(uint8_t *msg, size_t total_len,uint8_t *dst_mac, uint32_t src_ip, uint32_t dst_ip, uint16_t src_port, uint16_t dst_port)
{
